...
export function V6PageHero() {
  const t = useTranslations("site.solutions_operations.v6PageHero");
      ...
      <div className="wrap">
        <nav className="v6-usecase-nav" aria-label={t("useCases")}>
          {t.rich("salesCustomerSuccessMarketing", {
            ...
            a4: (chunks: ReactNode) => <Link href={`/${locale}/solutions-operations`} aria-current="page">{chunks}</Link>,
        ...
        <h1>
          {t("recordDecisionsOutstandingActions")}
        </h1>
        <p>
          {t("organizeAgreementsDecisionSources")}
        </p>
        <div className="btns">
