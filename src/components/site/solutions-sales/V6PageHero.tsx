...
export function V6PageHero() {
  const t = useTranslations("site.solutions_sales.v6PageHero");
      ...
      <div className="wrap">
        <nav className="v6-usecase-nav" aria-label={t("useCases")}>
          {t.rich("salesCustomerSuccessMarketing", {
            a: (chunks: ReactNode) => <Link href={`/${locale}/solutions-sales`} aria-current="page">{chunks}</Link>,
        ...
        <h1>
          {t("meetingPrepNotesFollow")}
        </h1>
        <p>
          {t("prepareBriefsCustomerContext")}
        </p>
        <div className="btns">
