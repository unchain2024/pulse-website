...
export function PulseAiHandoff() {
  ...
  return (
    <section className="pulse-ai-handoff v7-mcp" data-pulse-handoff="">
      <div className="wrap">
        <div className="pulse-section-copy">
          ...
          <div className="v7-mcp-logos">
            <span>
              <img data-asset="Claude" alt="" src="/assets/claude.svg" />
              {t("claude")}
            </span>
            <span>
              <img data-asset="ChatGPT" alt="" src="/assets/chatgpt.svg" />
              {t("chatgpt")}
            </span>
            <span>
              <img data-asset="Cursor" alt="" src="/assets/cursor.svg" />
              {t("cursor")}
            </span>
          </div>
        </div>
