...
export function V6PageHero() {
  const t = useTranslations("site.solutions_marketing.v6PageHero");
      ...
      <div className="wrap">
        <nav className="v6-usecase-nav" aria-label={t("useCases")}>
          {t.rich("salesCustomerSuccessMarketing", {
            ...
            a3: (chunks: ReactNode) => <Link href={`/${locale}/solutions-marketing`} aria-current="page">{chunks}</Link>,
        ...
        <h1>
          {t("recordInterviewsReferenceSource")}
        </h1>
        <p>
          {t("organizeCustomerInterviewsRelated")}
        </p>
        <div className="btns">
